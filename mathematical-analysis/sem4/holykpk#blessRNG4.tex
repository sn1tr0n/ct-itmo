...
Первое обуславливается $\tilde{C}^{\infty} \subset L^{\infty}$ и 3е свойство свёртки. Ну и дифференцируемость по Лейбницу:
...
Тут мы применили теорему о преобразовании Фурье и дифференцировании (пункт 2) (откуда у нас выполняется суммирование $|x|u(x, t)$ для работы 2го пункта? может, типа, раз уж суммируемые производные случились, то и преобразование Фурье сработает?).
