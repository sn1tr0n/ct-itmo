...
\begin{enumerate}
    ...
    \item Неравенство Коши (для сумм и для интегралов)
    \item Неравенство Гельдера для сумм
    \item Неравенство Гельдера для интегралов
...
\includepdf[pages={-}]{../images/Gel_inr.pdf}
