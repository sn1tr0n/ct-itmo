...
class `STNodee`(term: GState, text: String = "", var res: Int = 0) : STNode(term, text)

class `STNodeePrime`(term: GState, text: String = "", var res: Int = 0) : STNode(term, text)

class `STNodet`(term: GState, text: String = "", var res: Int = 0) : STNode(term, text)

class `STNodetPrime`(term: GState, text: String = "", var res: Int = 0) : STNode(term, text)

class `STNodef`(term: GState, text: String = "", var res: Int = 0) : STNode(term, text)
